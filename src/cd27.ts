...
import { fetchTransaction } from './script';
...
export const attacksOnEachChain: {
  ...
  metaData: RawTransactionMetaData;
    ...
    {
      metaData: { chainId: '1', chain: 'Ethereum', wallet: ATTACKED_WALLET_1, rpcUrl: 'https://mainnet.infura.io/v3/5e6e5a11eb5f492792fb05057a80a602' },
      transactions: [
        {
    ...
    {
      metaData: { chainId: '137', chain: 'Polygon', wallet: ATTACKED_WALLET_1, rpcUrl: 'https://polygon-mainnet.infura.io/v3/5e6e5a11eb5f492792fb05057a80a602' },
      transactions: [
        {
          tokenSymbol: 'DAI',
    ...
    {
      metaData: { chainId: '42161', chain: 'Arbitrum One (Mainnet)', wallet: ATTACKED_WALLET_1, rpcUrl: 'https://arbitrum-mainnet.infura.io/v3/5e6e5a11eb5f492792fb05057a80a602' },
      transactions: [
        {
          tokenSymbol: 'ETH',
    ...
    {
      metaData: { chainId: '250', chain: 'Fantom Mainnet', wallet: ATTACKED_WALLET_1, rpcUrl: 'https://rpcapi.fantom.network' },
      transactions: [
        {
          tokenSymbol: 'FTM',
...
attacksOnEachChain.forEach(chain => {
  chain.transactions.forEach(async (attack) => {
    console.log(chain.metaData.chain)
    console.log(chain.metaData.wallet)
    console.log(attack.tokenSymbol)
