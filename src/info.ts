...
const user = [
  {
    twitter: 'https://mobile.x.com/seanworkingdead',
    ens: 'seanworkingdead.eth',
    transaction: '0x7f1a020ba6dd0b2523cb8c91400e1d335f3a10e19415ea76a35c69e7bceca3cd',
  },
];
const a = {
  [KnownWalletsMap['0xD72CD83aFba0dCfEFf95D463adcB2b8dEf6aA623']]:
    'temp wallet made to handle mass payout it appears in usdc',
};
