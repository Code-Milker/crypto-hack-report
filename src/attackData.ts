...
import { getFileName, ADDRESS_CD27 } from './oldCode/utils';
import { TransactionPathFromAttack } from './types';
export const tokenName = "ChainLink Token (LINK)";
const fileName = getFileName(ADDRESS_CD27, tokenName);
...
const fileNameDemo = getFileName(ADDRESS_CD27, tokenName + 'demo');
getTransactionPathContextForAttack(chainLinkAttack, fileName).then().catch(console.log)
